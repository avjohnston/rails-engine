...
RSpec.configure do |config|
  ...
  def one_hundred_merchants
    @count = 1
    100.times do
      date = Date.today + @count.days
      Merchant.create!(name: 'Merchant', created_at: date, updated_at: date)
      @count += 1
    end
  end
  ...
  def merchant_1_with_history
    ...
    @invoice_1 = Invoice.create!(customer_id: @customer_1.id, status: 1, merchant_id: @merchant_1.id, status: 'shipped')
  ...
  def merchant_2_with_history
    ...
    @invoice_2 = Invoice.create!(customer_id: @customer_2.id, status: 1, merchant_id: @merchant_2.id, status: 'shipped')
  ...
  def merchant_3_with_history
    ...
    @invoice_3 = Invoice.create!(customer_id: @customer_3.id, status: 1, merchant_id: @merchant_3.id, status: 'shipped')
  ...
  def merchant_4_with_history
    ...
    @invoice_4 = Invoice.create!(customer_id: @customer_4.id, status: 1, merchant_id: @merchant_4.id, status: 'shipped')
    @invoice_5 = Invoice.create!(customer_id: @customer_4.id, status: 1, merchant_id: @merchant_4.id, status: 'shipped')
  ...
  def merchant_5_with_history
    ...
    @invoice_6 = Invoice.create!(customer_id: @customer_5.id, status: 1, merchant_id: @merchant_5.id, status: 'shipped')
    @invoice_7 = Invoice.create!(customer_id: @customer_5.id, status: 1, merchant_id: @merchant_5.id, status: 'shipped')
  ...
  def merchant_6_with_history
    ...
    @item_8 = @merchant_6.items.create!(name: 'Item 8', description: 'foo bar baz quux', unit_price: 10_000)
    @invoice_8 = Invoice.create!(customer_id: @customer_6.id, status: 1, merchant_id: @merchant_6.id, status: 'shipped')
    InvoiceItem.create!(invoice_id: @invoice_8.id, item_id: @item_8.id, quantity: 100, unit_price: 10_000)
