...
RSpec.describe "Api::V1::Merchants::MostItems", type: :request do
  ...
  describe 'when i search for a given quantity of merchants with the most sold items' do
    it 'returns the correct merchants with the correct format' do
      get api_v1_merchants_most_items_path, params: { quantity: 5 }
    ...
    it 'returns all merchants if quantity is more than total merchants' do
      get api_v1_merchants_most_items_path, params: { quantity: 100 }
    ...
    it 'returns an error if quantity is left blank' do
      get api_v1_merchants_most_items_path, params: { quantity: '' }
    ...
    it 'returns an error if quantity is a string' do
      get api_v1_merchants_most_items_path, params: { quantity: 'hello' }
